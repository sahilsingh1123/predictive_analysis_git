...
class LinearRegressionModel():
    ...
    def linearReg(self, dataset_add, feature_colm, label_colm, relation_list, relation):
        try:
            ...
            T_values = str(training_summary.tValues)Password restriction and email send option should be allow on Export table option.
            print(" p values :\n" + str(training_summary.pValues))
            P_values = str(training_summary.pValues)
Password restriction and email send option should be allow on Export table option.
