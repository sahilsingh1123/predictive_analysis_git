...
class LassoRegressionModel():
    ...
    def lassoRegression(self, dataset_add, feature_colm, label_colm, relation_list, relation,userId):
        try:
            ...
            # lasso final
            for t in self.xt:
                lr1 = LinearRegression(featuresCol="vectorIndexedFeatures", labelCol=label, elasticNetParam=1,
                                       regParam=t)
            ...
            for reg in final_regPara:
                lr_lasso = LinearRegression(featuresCol="vectorIndexedFeatures", labelCol=label, elasticNetParam=1,
                                            regParam=reg)
