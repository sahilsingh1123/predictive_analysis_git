...
class DataTransformation():
    ...
    def dataTranform(self,labelColm,featuresColm):
        ...
        result={"dataset":dataset,"categoricalFeatures":categoricalFeatures,"numericalFeatures":numericalFeatures,"maxCategories":maxCategories,"categoryColmStats":categoryColmListDict,"indexedFeatures":indexedFeatures,"label":label}
        return result
